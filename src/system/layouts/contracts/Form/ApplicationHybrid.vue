<template>
  <div class="row application-hybrid q-gutter-sm">
    <div class="col">
      <label-form textLabel="Valor à investir (R$)">
        <q-input
          input-class="text-white"
          color="white"
          bg-color="secondary"
          v-model="highPerfomance.amount"
          lazy-rules
          dense
    ...
    <div class="col">
      <label-form textLabel="Valor Médio de Apostes Mensais (R$)">
        <q-input
          input-class="text-white"
          color="white"
          bg-color="secondary"
          v-model="highPerfomance.amount_mensal"
          lazy-rules
          dense
          :rules="[(val) => (val && val.length > 0) || 'Campo obrigatório.']"
          standout
