<template>
  <q-banner
    class="paid-off-loans-section bg-transparent q-mb-lg"
    rounded
    :class="{ 'active-section': isActive }"
  >
    <div class="row justify-between items-center">
      <div class="col-10 row" style="align-content: space-between">
        <div class="col-12 row items-center">
          <q-avatar size="32px" flat class="text-positive">
            <component :is="icon" />
          </q-avatar>
        ...
        <div class="col-12 grid-loan-info q-mt-md q-ml-sm">
          <div
            ...
            style="color: #dcdcdc"
          >
            <p class="">Valor da Parcelas</p>
            <p class="row items-center">
              <span class="text-inter-17-400"> R$ {{ nextInstallment }} </span>
            </p>
          </div>
          <div
            class="grid-item simulation-status-description text-inter-17-400"
          ...
          >
            ...
            <p class="row items-center">
              <q-icon
                :name="`img:${administrationImage[adminstration]}`"
                class="bank-img"
              />
            </p>
          </div>
          ...
          <div
            ...
            style="color: #dcdcdc"
          >
            <p class="">Quitação em</p>
            <p class="row items-center text-primary">
              <span>{{ paidOff }}</span>
            </p>
          </div>
        </div>
      ...
      <div class="col-auto">
        ...
        >
          ...
          <span
            class="text-inter-12-400"
            style="color: #98989898; margin-top: 0.5rem"
          >
            Quitação
          </span>
        </q-circular-progress>
        ...
        <div class="row justify-between">
          <div class="col-auto">
            <q-btn flat no-caps color="primary">
              ...
              <IconArrowRight class="q-ml-md" width="24" height="24" />
            </q-btn>
          </div>
          <div class="col-auto">
            <q-btn
...
const discharge = computed(() => {
  const total = Number(props.totalInstallments) || 0;
...
const { typeLoanIcon, administrationImage } = useStates();
</script>
